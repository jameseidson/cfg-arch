...
static const char *fonts[]          = { "Misc Tamsyn:size=11:antialias=false" };
static const char dmenufont[]       = "Misc Tamsyn:size=11:antialias=false";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_backslash,    spawn,          {.v = volmutecmd } },
